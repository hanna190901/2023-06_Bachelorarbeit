...
//const long PERIOD_RELAX_END [BATTS] = {PERIOD_RELAX_BEGIN, PERIOD_RELAX_BEGIN, PERIOD_RELAX_BEGIN, PERIOD_RELAX_BEGIN}; // für Vormessung
...
boolean Logging[BATTS] = {true, true, true, true};       // diese Batterien werden geloggt
int Logging_count = 4;                  // Anzahl Batterien, die gerade geloggt werden
boolean Discharging[BATTS] = {true, true, true, true};   // diese Batterien werden gerade entladen
